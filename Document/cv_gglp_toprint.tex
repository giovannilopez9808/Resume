...
\documentclass[a3paper,15pt]{adcv}
...
\end{minipage}
 ...
 \\
  ...
  Todo esto por medio de una serie de códigos escritos en python y fortran para el análisis estadistico y gráficas.\\
  ...
  se creó una plataforma llamada \textit{TES para tu salud} en donde los pacientes puedan consultar el tiempo que ellos necesitan ingresando los parámetros antes especificados. Esta plataforma fue desarrollada como una
  página web haciendo uno de la libreria de Flask de python, código en HTML y CSS.\\
  ...
  a partir de una base de datos y así automatizar el cálculo de las irradiancias solares la cuales fueron analizadas con un código escrito en python.
  \end{multicols}
  \begin{multicols}{2}
\section{Educación}
...
\begin{minipage}{0.4\linewidth}
  \includegraphics[scale=0.7]{qr.png}
\end{minipage}
